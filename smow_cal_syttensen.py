...
std1_d17_mean = np.mean(bunch_instance_cal.d17[std1_index_on:std1_index_off])
std1_d17_std = np.std(bunch_instance_cal.d17[std1_index_on:std1_index_off])
...
std2_d17_mean = np.mean(bunch_instance_cal.d17[std2_index_on:std2_index_off])
std2_d17_std = np.std(bunch_instance_cal.d17[std2_index_on:std2_index_off])
...
std3_d17_mean = np.mean(bunch_instance_cal.d17[std3_index_on:std3_index_off])
std3_d17_std = np.std(bunch_instance_cal.d17[std3_index_on:std3_index_off])
...
p_cal_17 = np.polyfit([std1_d17_mean, std3_d17_mean], [std1_d17, std3_d17], 1)
p_cal_D = np.polyfit([std1_dD_mean, std3_dD_mean], [std1_dD, std3_dD], 1)

std2_d18_cal = np.polyval(p_cal_18, std2_d18_mean)
std2_d17_cal = np.polyval(p_cal_17, std2_d17_mean)
