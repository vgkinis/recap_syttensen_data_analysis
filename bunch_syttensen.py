...
class Bunch(object):
    ...
    def read_data(self, filename):
        ...
        try:
            index_date = np.where(header == "DATE")[0][0]
        except:
            print("Some of the data fields were not read properly")

        try:
            index_days_since_jan = np.where(header == "FRAC_DAYS_SINCE_JAN1")[0][0]
        except:
            print("Some of the data fields were not read properly")

        try:
            index_epoch = np.where(header == "EPOCH_TIME")[0][0]
        except:
            print("Some of the data fields were not read properly")

        try:
            index_water_ppm = np.where(header == "H2O")[0][0]
        except:
            print("Some of the data fields were not read properly")

        try:
            index_peak1 = np.where(header == "peak1")[0][0]
        except:
            print("Some of the data fields were not read properly")

        try:
            index_peak2 = np.where(header == "peak2")[0][0]
        except:
            print("Some of the data fields were not read properly")

        try:
            index_peak3 = np.where(header == "peak3")[0][0]
        except:
            print("Some of the data fields were not read properly")

        try:
            index_peak11 = np.where(header == "peak_11")[0][0]
        except:
            print("Some of the data fields were not read properly")

        try:
            index_peak13 = np.where(header == "peak_13")[0][0]
        except:
            print("Some of the data fields were not read properly")

        try:
            index_peak1_offset = np.where(header == "peak1_offset")[0][0]
        except:
            print("Some of the data fields were not read properly")

        try:
            index_peak2_offset = np.where(header == "peak2_offset")[0][0]
        except:
            print("Some of the data fields were not read properly")

        try:
            index_peak3_offset = np.where(header == "peak3_offset")[0][0]
        except:
            print("Some of the data fields were not read properly")

        try:
            index_d18 = np.where(header == "Delta_18_16")[0][0]
        except:
            print("Some of the data fields were not read properly")

        try:
            index_dD = np.where(header == "Delta_D_H")[0][0]
        except:
            print("Some of the data fields were not read properly")

        try:
            index_d17 = np.where(header == "Delta_17_16")[0][0]
        except:
            print("Some of the data fields were not read properly")
        ...
        try:
            index_cavity_temp = np.where(header == "CavityTemp")[0][0]
        except:
            print("Some of the data fields were not read properly")

        try:
            index_cavity_pressure = np.where(header == "CavityPressure")[0][0]
        except:
            print("Some of the data fields were not read properly")

        try:
            index_baseline_shift = np.where(header == "baseline_shift")[0][0]
        except:
            print("Some of the data fields were not read properly")

        try:
            self.epoch = data[:,index_epoch].astype("float")
            self.date_i = data[:,index_date].astype("string")
    ...
    def save_ascii(self, filename, z = False):
        """
